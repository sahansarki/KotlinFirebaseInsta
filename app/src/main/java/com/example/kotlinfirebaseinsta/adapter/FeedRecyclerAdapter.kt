                    ...
                    if (!snapshot.isEmpty) {
                        ...
                        for(document in documents) {
                            if(document.get("email") as String == post!![position].userEmail) {
                                Picasso.get().load(document.get("photoUrl") as String).into(holder.itemView.recyclerUserPhoto)
                                holder.itemView.recyclerCommentName?.text = document.get("username") as String
                                holder.itemView.recyclerEmailText?.text = document.get("username") as String
                            }
                        }
                    }
                }
